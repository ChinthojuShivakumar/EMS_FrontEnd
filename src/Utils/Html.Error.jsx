...
const HtmlErrorPage = () => {
  ...
  const objectPayload = JSON.parse(sessionStorage.getItem("objectPayload")) || {}
  ...
  const statusCode = JSON.parse(sessionStorage.getItem("statusCode")) || ""
  ...
  const handleCopy = (e, type) => {
    ...
    const dataString = typeof dataToCopy === 'object' ? JSON.stringify(dataToCopy, null, 2) : dataToCopy;
    ...
    <div className="h-auto p-4 font-roboto bg-gray-100 w-full">
      ...
      <div className="flex gap-5 ">
        ...
        <div className="mb-6 w-[50%] border-e-2 border-black">
          <h2 className="text-lg font-semibold text-gray-700">Frontend Request :</h2>
          <div style={{ padding: "20px" }} className="flex flex-col gap-5">
            <div className="w-full justify-between items-center flex">
              <h1>URL with End Point:</h1>
              <p className="hover:cursor-pointer hover:underline hover:text-blue-500" onClick={(e) => handleCopy(e, "baseUrl")}>Copy Url</p>
            </div>
            <div
              style={{
            ...
            >
              <h1><strong>Domain Url with End Point</strong>: </h1>
              <h1><span>{url}</span></h1>
              <h1><strong>Method</strong>: <span>{method}</span></h1>
              <h1><strong>status</strong>: <span>{statusCode}</span></h1>
            </div>
            <div className="w-full justify-between items-center flex">
              <h1>Payload:</h1>
              <p className="hover:cursor-pointer hover:underline hover:text-blue-500" onClick={(e) => handleCopy(e, "token")}>Copy Token</p>
            </div>
            <div
              style={{
                backgroundColor: "#f4f4f4",
            ...
            >
              <h1><strong>Token</strong>: <span>{token}</span></h1>
              {/* <h1><strong>Method</strong>: <span>{method}</span></h1> */}
            </div>
            <div className="w-full justify-between items-center flex">
              <h1>Payload:</h1>
              <p className="hover:cursor-pointer hover:underline hover:text-blue-500" onClick={(e) => handleCopy(e, "payload")}>Copy Payload</p>
            </div>
            <div
              style={{
                backgroundColor: "#f4f4f4",
            ...
            >
              ...
              <ul>
                ...
                {!Array.isArray(files) && typeof files === 'object' && files !== null && (
        ...
        <div className="w-[50%]">
          ...
          <p className="w-full flex justify-end hover:cursor-pointer hover:text-blue-600 hover:underline" onClick={(e) => handleCopy(e, "response")}>Copy Response</p>
          <div style={{ padding: "20px" }}>
            ...
            >
              <div className="break-words flex flex-wrap space-x-4" style={{ whiteSpace: 'normal', wordWrap: 'break-word' }} dangerouslySetInnerHTML={{ __html: modifiedHtmlContent }} />
              <div>
                <button
                  onClick={handleBack}
